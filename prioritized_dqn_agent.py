...
from replay_buffer import PrioritizrdReplayBuffer as ReplayBuffer
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = QNetwork(state_size, action_size, seed, fc1_units=80).to(device)
        self.qnetwork_target = QNetwork(state_size, action_size, seed, fc1_units=80).to(device)
